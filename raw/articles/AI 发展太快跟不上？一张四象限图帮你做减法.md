...
![AI 发展太快跟不上？一张四象限图帮你做减法]\(../assets/6376f1ee/image_01.png\)
...
![AI 学习优先级四象限框架]\(../assets/6376f1ee/image_02.png\)
...
![直接跳过的噪音]\(../assets/6376f1ee/image_03.png\)
...
**Chain-of-Thought（思维链）**：o1/o3 这类推理模型为什么要“想一会儿”再回答**Scaling Laws**：为什么模型越大越聪明、为什么训练成本是天文数字**AI 幻觉**：AI 一本正经胡说八道的原理**多模态**：文本图像音频视频怎么融合到一个模型里
...
![维持 AI 知识地图感]\(../assets/6376f1ee/image_04.png\)
...
![工具迭代快，用但别深投]\(../assets/6376f1ee/image_05.png\)
...
![深度投入的复利效应]\(../assets/6376f1ee/image_06.png\)
...
![象限会移动：事物在四象限间的迁移路径]\(../assets/6376f1ee/image_07.png\)
