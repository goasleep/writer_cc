...
![构建 Claude Code 的经验：我们如何使用 Skills]\(../assets/3801f816/image_01.jpg\)
...
译者导读本文作者 Thariq Shihipar（@trq212）是 Anthropic 的 Claude Code 团队工程师，也是 Skills 功能的核心推动者之一。在加入 Anthropic 之前，他在 MIT Media Lab 读研期间联合创建了开源学术发布平台 PubPub，后来参加了 Y Combinator（W20 批次）。他在 X 上经常分享 Claude Code 的一手使用经验和新功能动态。
...
![]\(../assets/3801f816/image_06.jpg\)

## 考虑好初始设置

![]\(../assets/3801f816/image_07.jpg\)
...
![]\(../assets/3801f816/image_08.jpg\)

## 记忆与数据存储

![]\(../assets/3801f816/image_09.jpg\)
...
![]\(../assets/3801f816/image_10.jpg\)

Claude 就可以即时生成脚本来组合这些功能，完成更高级的分析——比如回答“周二发生了什么？”这样的问题。

![]\(../assets/3801f816/image_11.jpg\)
